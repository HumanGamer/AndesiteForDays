...
public class DataCreator {
    ...
    private static class Language extends LanguageProvider {
        ...
        protected void addTranslations() {
            add(TIER1_BLOCK.get(), "Andesite Gen Tier1");
            add(TIER2_BLOCK.get(), "Andesite Gen Tier2");
            add(TIER3_BLOCK.get(), "Andesite Gen Tier3");
            add(TIER4_BLOCK.get(), "Andesite Gen Tier4");
            add(TIER5_BLOCK.get(), "Andesite Gen Tier5");
        }
    }
